...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  useGSAP(
    () => {
      ...
      const useScrollTrigger = scrollTriggerEnabled;
      ...
      const splitInstance = new GSAPSplitText(el, {
        ...
        onSplit: (self: GSAPSplitText) => {
          ...
          if (useScrollTrigger && start) {
            baseTo.scrollTrigger = {
              trigger: el,
              start,
              once: true,
              fastScrollEnd: true,
          ...
          return gsap.fromTo(targets, { ...from }, baseTo);
        },
      });
  ...
  const classes = `split-parent pointer-events-none select-none overflow-hidden inline-block whitespace-normal ${className}`;
