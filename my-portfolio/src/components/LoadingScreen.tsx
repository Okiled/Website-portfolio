  ...
  return (
    <div className={`fixed inset-0 z-50 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center transition-opacity duration-500 ${isComplete ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="relative z-10 text-center max-w-md mx-auto px-6">
        ...
        {/* Loading text */}
        <div className="mb-8">
          <p className="text-white/80 text-lg mb-2 h-6 animate-pulse">
            {currentText}
          </p>
        </div>
      ...
      {/* Corner decorations */}
      <div className="absolute top-8 left-8 w-8 h-8 border-t-2 border-l-2 border-cyan-400/30 animate-pulse"></div>
      <div className="absolute top-8 right-8 w-8 h-8 border-t-2 border-r-2 border-purple-400/30 animate-pulse"></div>
      <div className="absolute bottom-8 left-8 w-8 h-8 border-b-2 border-l-2 border-purple-400/30 animate-pulse"></div>
      <div className="absolute bottom-8 right-8 w-8 h-8 border-b-2 border-r-2 border-cyan-400/30 animate-pulse"></div>
